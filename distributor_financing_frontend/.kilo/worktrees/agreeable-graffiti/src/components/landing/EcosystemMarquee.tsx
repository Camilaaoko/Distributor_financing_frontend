...
const ECOSYSTEM_PARTNERS: PartnerLogoItem[] = [
  ...
  },
  {
    ...
    category: "Commercial Bank",
    badgeColor: "bg-blue-50 text-[#1F4DA8] border-blue-200",
    imageSrc: "/images/equity-bank-logo.png",
  },
  {
    id: "coke",
    ...
    category: "Anchor Manufacturer",
    badgeColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
    imageSrc: "/images/Coca-Cola_logo.svg.webp",
  },
  {
    id: "absa",
    ...
    category: "Commercial Bank",
    badgeColor: "bg-blue-50 text-[#1F4DA8] border-blue-200",
    imageSrc: "/images/absa-logo-bg.png",
  },
  {
    id: "galana",
    name: "Galana Oil",
  ...
  },
  {
    ...
    category: "Commercial Bank",
    badgeColor: "bg-blue-50 text-[#1F4DA8] border-blue-200",
    imageSrc: "/images/ncba-logo-dark.svg",
  },
  {
    id: "kapa",
    ...
    category: "Anchor Manufacturer",
    badgeColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
    imageSrc: "/images/Kapa-Oil-Refineries-Limited-logo.webp",
  },
  {
    id: "safaricom",
    ...
    imageSrc: "/images/safaricom-25.gif",
  },
  {
    id: "visa",
    name: "Visa Direct",
  ...
  },
  {
    ...
    category: "Commercial Bank",
    badgeColor: "bg-blue-50 text-[#1F4DA8] border-blue-200",
    imageSrc: "/images/Coop-Logo-02-1.png",
  },
  {
    id: "kpc",
  ...
  },
  {
    ...
    category: "Anchor Manufacturer",
    badgeColor: "bg-emerald-50 text-emerald-700 border-emerald-200",
    imageSrc: "/images/Coke-company-logo-black.svg",
  },
  {
    id: "imb",
    name: "I&M Bank",
  ...
  },
  {
    ...
    category: "Commercial Bank",
    badgeColor: "bg-blue-50 text-[#1F4DA8] border-blue-200",
    imageSrc: "/images/family-bank-40-logo.jpg",
  },
  {
    id: "mastercard",
    name: "Mastercard",
    category: "Payment Network",
    badgeColor: "bg-purple-50 text-purple-700 border-purple-200",
    imageSrc: "/images/mastercard.webp",
  },
];
