    ...
    <div className="h-72">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={platformGrowthSeries} margin={{ top: 8, right: 12, left: -12, bottom: 0 }}>
          ...
          />
          <Line type="monotone" dataKey="users" name="Platform Users" stroke="#1F4DA8" strokeWidth={3} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="banks" name="Banks Registered" stroke="#F58220" strokeWidth={3} dot={{ r: 4 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
