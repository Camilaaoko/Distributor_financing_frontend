...
export const onboardingService = {
  ...
  async getDistributorRecommendations(): Promise<DistributorRecommendation[]> {
    ...
    const res = await distributorApi.getRecommendations();
    return (res || []).map((d: DistributorRecommendationResponse) => ({
      ...d,
  ...
  async createDistributorRecommendation(payload: RecommendDistributorRequest): Promise<DistributorRecommendation> {
    ...
    const res = await manufacturerApi.recommendDistributor(payload);
    const rec: any = (res as any)?.data || (res as any)?.result || res;
    return {
      ...rec,
      email: rec?.contactEmail || rec?.email || '',
      phoneNumber: rec?.contactPhone || rec?.phoneNumber || '',
      distributorName: rec?.distributorName || '',
    };
  },
  ...
  async reviewDistributorRecommendation(payload: ReviewDistributorRequest): Promise<DistributorRecommendation> {
    ...
    const res = await distributorApi.reviewRecommendation(payload.recommendationId || '', formatted);
    const rec: any = (res as any)?.data || (res as any)?.result || res;
    return {
      ...rec,
      email: rec?.contactEmail || '',
      phoneNumber: rec?.contactPhone || '',
      distributorName: rec?.distributorName || '',
    };
  },
  ...
  async uploadDistributorDocument(formData: FormData): Promise<{ url?: string; downloadUrl?: string; documentUrl?: string; [key: string]: any }> {
    return distributorDocumentsApi.uploadDocument(formData);
  },
  ...
  async onboardDistributorAdmin(payload: OnboardDistributorAdminRequest): Promise<UserResponse> {
    ...
    return ((res as any)?.data || (res as any)?.result || res) as UserResponse;
  },
  ...
  async getDistributorDashboardStats(): Promise<DistributorDashboardStatsResponse> {
    return distributorApi.getDashboardStats();
  },
  ...
  async getManufacturerDashboardStats(): Promise<ManufacturerDashboardStatsResponse> {
    return manufacturerApi.getDashboardStats();
  },
  ...
  async getManufacturerUser(id: string): Promise<UserResponse> {
    ...
    return manufacturerApi.getManufacturerUserById(id);
  },
  ...
  async deleteManufacturerUser(id: string): Promise<void> {
    ...
    await manufacturerApi.deactivateManufacturerUser(id);
  },
  ...
  async getDistributorUser(id: string): Promise<UserResponse> {
    ...
    return distributorApi.getDistributorUserById(id);
  },
  ...
  async deleteDistributorUser(id: string): Promise<void> {
    ...
    await distributorApi.deactivateDistributorUser(id);
  },
  ...
  async createBank(payload: OnboardBankRequest): Promise<BankResponse> {
    ...
    return ((res as any)?.data || (res as any)?.result || res) as BankResponse;
  },
  ...
  async deleteBank(id: string): Promise<void> {
    ...
    await bankOnboardingApi.deleteBank(id);
  },
  ...
  async getAvailableBranches(bankCode: string): Promise<Branch[]> {
    return bankOnboardingApi.getAvailableBranches(bankCode);
  },
