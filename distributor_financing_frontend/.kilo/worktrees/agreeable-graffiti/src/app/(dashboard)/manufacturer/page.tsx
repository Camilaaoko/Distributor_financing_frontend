      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200/80 pb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="bg-white border border-slate-200 text-slate-700 text-xs font-bold rounded-xl px-3.5 py-2 shadow-2xs flex items-center gap-2 hover:bg-slate-50 disabled:opacity-50 cursor-pointer"
          >
