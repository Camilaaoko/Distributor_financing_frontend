...
export default function ManufacturerReportsPage() {
  ...
  const handleExport = () => {
    ...
    setTimeout(() => {
      ...
      alert(`Report "${reportType}" successfully generated and downloaded as Excel (.xlsx)!`);
    }, 1000);
  };
  ...
  return (
    <div className="space-y-6 p-6 max-w-[1600px] mx-auto bg-slate-50 min-h-screen">
      <ManufacturerHeader 
        title="Reports" 
        subtitle="Generate and export operational, referral conversion, and financing reports." 
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-3.5 bg-blue-50/70 border border-blue-200 rounded-lg text-[11px] text-blue-900 space-y-1">
              <p className="font-bold flex items-center gap-1">
                <CheckCircle2 className="w-3.5 h-3.5 text-blue-700" /> Excel Export Standard:
              </p>
            ...
            >
              ...
              {isExporting ? "Generating Excel Export..." : "Export Report to Excel (.xlsx)"}
            </button>
          </div>
        </Card>
        ...
        <Card className="bg-white border-slate-200/80 shadow-xs rounded-xl p-6 space-y-4">
          ...
          <div className="space-y-3 text-xs">
            {[
              { name: "Referral Conversion Jul 2026.xlsx", size: "1.2 MB", date: "Aug 01, 2026" },
              { name: "Drawdown Summary Q2.xlsx", size: "3.4 MB", date: "Jul 15, 2026" },
              { name: "Invoicing Statement Jun 2026.xlsx", size: "850 KB", date: "Jul 01, 2026" },
            ].map((file, idx) => (
