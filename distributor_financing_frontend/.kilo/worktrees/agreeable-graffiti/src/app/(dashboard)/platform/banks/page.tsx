...
function BanksContent() {
  ...
  const { banks, isLoading, isMutating, error, refresh, createBank, createBankAdmin, setBankStatus, deleteBank } = useBanks();
  ...
  const handleCreateBank = async (input: { bankCode: string; branchCode: string; name?: string; branch?: string }) => {
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative flex-1 w-full">
          ...
          <TextInput
            ...
            placeholder="Search by bank name, bank code, branch, branch code..."
