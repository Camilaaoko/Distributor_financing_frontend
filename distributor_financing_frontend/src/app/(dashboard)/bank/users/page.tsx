...
export default function BankUsersPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">Bank Staff Management</h1>
        <p className="text-sm text-slate-500 mt-0.5">
          Manage staff users, branch assignments, and maker/checker operations for your bank institution.
        </p>
      </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <div className="relative flex-1 min-w-[220px]">
            ...
            <TextInput
              ...
              placeholder="Search name, email, phone, branch, employee ID..."
              className="pl-9"
          ...
          >
            ...
            {branches.map((b) => (
              <option key={b.id || b.branchCode} value={b.branchCode || b.id}>
                {b.branchName || b.branch || `Branch ${b.branchCode}`}
              </option>
            ))}
          </Select>
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-semibold text-white bg-[#1F4DA8] hover:bg-[#3A6FD8] rounded-xl px-4 py-2.5 shadow-sm shadow-[#1F4DA8]/30 cursor-pointer"
            >
