...
/**
 * Enables only the reports fixtures while the rest of the application continues
 * to use live APIs. Intended for report UI development before the reports
 * service is available.
 */
export const USE_REPORT_MOCKS = process.env.NEXT_PUBLIC_USE_REPORT_MOCKS === 'true';
